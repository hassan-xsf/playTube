    ...
    return (<>
        <div className={`rounded-2xl flex cursor-pointer hover:scale-105 hover:transition-all flex-col bg-theme ${className}">`}>
            ...
            <div className="flex mt-2 gap-3">
                {
                    data.videoOwner && <Link to={`/c/${data.videoOwner.username}/videos`} className="rounded-full size-10 sm:size-12 bg-white flex justify-center items-center overflow-hidden">
