            ...
            <div className="fixed inset-0 z-12 flex flex-col items-center justify-center bg-black/50 px-4 pt-4">
                <div class="mx-auto w-full max-w-lg overflow-auto rounded-lg border border-gray-700 bg-theme p-4">
                    <div class="mb-6 flex items-start gap-4">
                        <span class="h-8 w-8 shrink-0 rounded-full ring-red-900 ring-1 bg-theme p-1 text-red-700">
                            <svg
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <button className="py-2 px-4 bg-black dark:bg-white text-white text-xl font-bold rounded-md dark:text-black">
                            Cancel
                        </button>
                    </div>
                </div>
