        ...
        <>
            ...
            <div className="grid lg:grid-cols-3 gap-10 w-[95%] mx-auto">
                <div className="grid grid-rows-2 justify-center py-6 lg:h-48 bg-black bg-opacity-10 dark:bg-gray-100 dark:bg-opacity-10 rounded-xl ">
                    ...
                    <span className="text-3xl lg:text-4xl 2xl:text-6xl font-semibold text-theme text-center">500,000</span>
                </div>
                <div className="grid grid-rows-2 justify-center py-6 h-48 bg-black bg-opacity-10 dark:bg-gray-100 dark:bg-opacity-10 rounded-xl ">
                    ...
                    <span className="text-3xl lg:text-4xl 2xl:text-6xl font-semibold text-theme text-center">10,000</span>
                </div>
                <div className="grid grid-rows-2 justify-center py-6 h-48 bg-black bg-opacity-10 dark:bg-gray-100 dark:bg-opacity-10 rounded-xl ">
                    <div className="flex items-center justify-center mb-10 gap-4">
                        <span className="size-10 rounded-full flex justify-center items-center bg-theme">
                    ...
                    <span className="text-3xl lg:text-4xl 2xl:text-6xl font-semibold text-theme text-center">5,000</span>
                </div>
            </div>
    ...
    return (
        <>
            <div className="flex items-center lg:items-start justify-center gap-4 bg-black bg-opacity-10 dark:bg-gray-100 dark:bg-opacity-10 rounded-3xl p-2">
                <div className="rounded-xl size-40 bg-white flex justify-center items-center overflow-hidden">
                ...
                <div className="flex flex-col items-start w-[100%] lg:w-[80%]">
                    <span className="font-[600] tracking-normal text-lg lg:text-2xl text-theme mb-4">DSA Fundamenetals</span>
