        ...
        <>
            ...
            <div class="h-screen overflow-y-auto bg-[#121212] text-white">
                ...
                <div class="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
                    <aside
                        class="group fixed inset-x-0 bottom-0 z-40 w-full shrink-0 border-t border-white bg-[#121212] px-2 py-2 sm:absolute sm:inset-y-0 sm:max-w-[70px] sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-[250px]">
                        <ul class="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
                            <li class="">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">Home</span>
                                </button>
                            </li>
                            <li class="hidden sm:block">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">Liked Videos</span>
                                </button>
                            </li>
                            <li class="">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">History</span>
                                </button>
                            </li>
                            <li class="hidden sm:block">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">My Content</span>
                                </button>
                            </li>
                            <li class="">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">Collections</span>
                                </button>
                            </li>
                            <li class="">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">Subscribers</span>
                                </button>
                            </li>
                            <li class="hidden sm:block mt-auto">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">Support</span>
                                </button>
                            </li>
                            <li class="hidden sm:block">
                                <button
                                    ...
                                    <span class="block sm:hidden sm:group-hover:inline">Settings</span>
                                </button>
                            </li>
                        </ul>
                    </aside>
                                    ...
                                    <div>
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mt-3 text-sm">Render props have always been a bit tricky for me. Can&#x27;t wait to see how this series breaks it down. Thanks for sharing!</p>
                                            </div>
                                        </div>
                                        <hr class="my-4 border-white" />
                                    </div>
                                    <div>
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mt-3 text-sm">Higher-order components have been a mystery to me for far too long. Looking forward to demystifying them with this series. Thanks!</p>
                                            </div>
                                        </div>
                                        <hr class="my-4 border-white" />
                                    </div>
                                    <div>
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mt-3 text-sm">Compound components are a game-changer for UI development. Can&#x27;t wait to learn more about them. Great work on this series!</p>
                                            </div>
                                        </div>
                                        <hr class="my-4 border-white" />
                                    </div>
                                    <div>
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mt-3 text-sm">Controlled vs. uncontrolled components - finally! This topic has always confused me. Thanks for breaking it down!</p>
                                            </div>
                                        </div>
                                        <hr class="my-4 border-white" />
                                    </div>
                                    <div>
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mt-3 text-sm">This series is a goldmine for React developers! Compound components are something I&#x27;ve been eager to master. Thanks for this!</p>
                                            </div>
                                        </div>
                                        <hr class="my-4 border-white" />
                                    </div>
                                    <div>
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mt-3 text-sm">This is exactly what I needed to take my React skills to the next level. Looking forward to diving into the render props section!</p>
                                            </div>
                                        </div>
                                        <hr class="my-4 border-white" />
                                    </div>
                                    <div>
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mt-3 text-sm">This series looks amazing! I&#x27;m especially excited to learn more about controlled vs. uncontrolled components. Thanks for sharing!</p>
                                            </div>
                                        </div>
                                        <hr class="my-4 border-white" />
                                    </div>
                            ...
                            <div class="col-span-12 flex w-full shrink-0 flex-col gap-3 lg:w-[350px] xl:w-[400px]">
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Getting Started with Express.js</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Building a RESTful API with Node.js and Express</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Introduction to React Native</h6>
                                            <p class="mb-0.5 mt-2 text-sm text-gray-200">React Native Dev</p>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Creating Custom Hooks in React</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Building Scalable Web Applications with Django</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Creating Interactive UIs with React and D3</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Node.js Authentication with Passport.js</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Data Visualization with Tableau</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Building Real-Time Applications with Socket.IO</h6>
                                            <p class="mb-0.5 mt-2 text-sm text-gray-200">Socket.IO Expert</p>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Advanced CSS: Animations and Transitions</h6>
                                ...
                                <div class="w-full gap-x-2 border pr-2 md:flex">
                                    ...
                                    <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
                                        ...
                                        <div class="w-full pt-1 md:pt-0">
                                            <h6 class="mb-1 text-sm font-semibold">Advanced React Patterns</h6>
