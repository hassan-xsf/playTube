                    ...
                    <section class="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
                        ...
                        <div class="px-4 pb-4">
                            ...
                            <ul class="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
                                <li class="w-full"><button class="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Personal Information</button></li>
                                <li class="w-full"><button class="w-full border-b-2 border-[#ae7aff] bg-white px-3 py-1.5 text-[#ae7aff]">Channel Information</button></li>
                                <li class="w-full"><button class="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Change Password</button></li>
                            </ul>
                                ...
                                <div class="w-full sm:w-1/2 lg:w-2/3">
                                    <div class="rounded-lg border">
                                        <div class="flex flex-wrap gap-y-4 p-4">
                                            <div class="w-full">
                                                ...
                                                <div class="flex rounded-lg border">
                                                    <p class="flex shrink-0 items-center border-r border-white px-3 align-middle">vidplay.com/</p>
                                                    <input
                                                        type="text"
                                        ...
                                        <div class="flex items-center justify-end gap-4 p-4">
                                            ...
                                            <button class="inline-block bg-[#ae7aff] px-3 py-1.5 text-black">Save changes</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
