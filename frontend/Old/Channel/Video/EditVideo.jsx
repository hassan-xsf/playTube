                            ...
                            <table class="w-full min-w-[1200px] border-collapse border text-white">
                                ...
                                <tbody>
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/22/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/21/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/20/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/19/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/18/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/17/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/16/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/15/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/14/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/13/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/12/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/11/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/10/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/9/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/8/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/7/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/6/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/5/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/4/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/3/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/2/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">9/1/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">8/31/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">8/30/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                                    ...
                                    <tr class="group border">
                                        ...
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">8/29/2023</td>
                                        <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                                            <div class="flex gap-4">
                                                <button class="h-5 w-5 hover:text-[#ae7aff]">
                                                    <svg
                    ...
                    <div class="fixed inset-0 top-[calc(66px)] z-10 flex flex-col bg-black/50 px-4 pb-[86px] pt-4 sm:top-[calc(82px)] sm:px-14 sm:py-8">
                        <div class="mx-auto w-full max-w-lg overflow-auto rounded-lg border border-gray-700 bg-[#121212] p-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <button class="bg-[#ae7aff] px-4 py-3 text-black disabled:bg-[#E4D3FF]">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
